...
public class Kaloda {
    ...
    public void prepeare(){
        // создать 52 карты и поместить их в массив
        ...
        cards[20] = new Card("Седмерка трефа", 7);
        cards[21] = new Card("Седмерка бубна", 7);
        cards[22] = new Card("Седмерка пика", 7);
        cards[23] = new Card("Седмерка черви", 7);

        cards[24] = new Card("Восмерка трефа", 8);
        cards[25] = new Card("Восмерка бубна", 8);
        cards[26] = new Card("Восмерка пика", 8);
        cards[27] = new Card("Восмерка черви", 8);
    ...
    //   метод возвращает 1 карту рандомно из 52
